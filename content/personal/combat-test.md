...
uniformly slow drains the force out of the action. The solution is uneven. Accelerate into the rotation, hold a legible attitude at the point where the
...
This is one of the few places where exaggeration is not really exaggeration, because vertical velocity genuinely approaches zero at the top of a jump, so the
